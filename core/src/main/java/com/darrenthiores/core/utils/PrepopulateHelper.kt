...
object PrepopulateHelper {
    ...
    fun fillWithStartingData(startingDao: StartingDao) {

        Executors.newSingleThreadExecutor().execute {
            startingDao.initialStarting(
                StartingEntity(
                    id = 1,
                    playerId = 353865,
    ...
    fun fillWithUserPlayer(userPlayerDao: UserPlayerDao) {

        Executors.newSingleThreadExecutor().execute {
            userPlayerDao.initialUserPlayer(
                UserPlayerEntity(
                    id = 0,
                    playerId = 1438,
                    name = "Bernd Leno",
